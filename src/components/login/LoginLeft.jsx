...
const LoginLeft = () => {
  ...
  return (
    ...
    >
      ...
      <div className=" w-full m-auto relative group bg-[#FCFCFD] rounded-lg border ">
        <div className="p-[50px] ">
          <motion.p
            whileInView={{ translateX: ["-30px", 0], opacity: [0, 1] }}
            transition={{ duration: 0.5 }}
            className="text-[#4C4C4D]  text-[18px]"
          >
        ...
        <div className="py-[30px] px-[50px] flex items-center justify-between">
          ...
          <button className=" py-[18px] px-[24px] bg-[#F7F7F8] border-[1px] border-[solid] border-[#F1F1F3] rounded-lg text-[18px] font-medium text-[#262626] hover:bg-[#FF9500] hover:text-[#fff]">
            Read More
          </button>
        </div>
        {/* Left Arrow */}
